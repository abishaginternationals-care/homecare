    ...
    <>
      ...
      <a
        ...
        style={{
          ...
          transform: open ? 'translateY(20px) scale(0.9)' : 'translateY(0) scale(1)',
        }}
        onMouseEnter={(e) => {
          if (!open) e.currentTarget.style.transform = 'translateY(-4px) scale(1.05)';
        }}
        onMouseLeave={(e) => {
          if (!open) e.currentTarget.style.transform = 'translateY(0) scale(1)';
        }}
      >
